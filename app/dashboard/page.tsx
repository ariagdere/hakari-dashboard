              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 3, marginTop: 4, paddingTop: 8, borderTop: '1px solid var(--border)' }}>
                  {[
                    ...
                    { label: 'Ort. Max Kazanç', val: stats.avg_max_fav_tp != null ? `$${parseFloat(String(stats.avg_max_fav_tp)).toFixed(2)}` : '—' },
                  ].map((x, i) => (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 3, marginTop: 4, paddingTop: 8, borderTop: '1px solid var(--border)' }}>
                  {[
                    ...
                    { label: 'Ort. Max Kazanç', val: stats.avg_max_fav_sl != null ? `$${parseFloat(String(stats.avg_max_fav_sl)).toFixed(2)}` : '—' },
                  ].map((x, i) => (
                    <div key={i} style={{ display: 'flex', justifyContent: 'space-between' }}>
                      <span className="col-label">{x.label}</span>
                      <span className="mono" style={{ fontSize: 11, color: 'var(--text-2)' }}>{x.val}</span>
