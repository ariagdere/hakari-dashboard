...
export async function GET(req: NextRequest) {
  ...
  const query = `
    SELECT
      ...
      win_probability_v4_1304_reverse,
      win_probability_v5_1304_reverse,
  ...
  const headers = [
    ...
    'rsi_4h', 'rsi_30m',
    'sim_result', 'sim_r', 'sim_pnl',
    'trade_duration_mins', 'entry_wait_mins',
    'wp_v4_1304', 'wp_v5_1304', 'wp_v4_1304_rev', 'wp_v5_1304_rev',
  ...
  const lines = [
    headers.join(','),
    ...rows.map(r => [
      r.analyzed_at ? new Date(r.analyzed_at).toISOString() : '',
      r.direction, r.entry, r.tp, r.sl, r.rr,
      r.tp_distance, r.sl_distance,
      r.rsi_4h, r.rsi_30m,
      r.sim_result, r.sim_r_multiple, r.sim_pnl_usd,
      r.trade_duration_mins, r.entry_wait_mins,
      r.win_probability_v4_1304, r.win_probability_v5_1304,
      r.win_probability_v4_1304_reverse, r.win_probability_v5_1304_reverse,
