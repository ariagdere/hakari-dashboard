...
// insights-cumr'nin pullback paraleli — sim_result_pullback / pullback_sim_r_multiple bazlı.
// pullback_sim_r_multiple $ değil R multiple olduğu için daily_pnl null döner.
...
export async function GET(req: NextRequest) {
  ...
  const dailyQ = `
    SELECT
      ...
      SUM(pullback_sim_r_multiple) AS daily_r,
      COUNT(*) AS trade_count
    FROM btc_analysis
    ${base} sim_result_pullback IN ('TP_HIT','SL_HIT')
